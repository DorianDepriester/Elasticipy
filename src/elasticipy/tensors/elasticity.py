...
class StiffnessTensor(SymmetricFourthOrderTensor):
    ...
    def inv(self):
        ...
        >>> S = C.inv()
        >>> print(S * 1000) # S in /TPa
        Compliance tensor (in Voigt mapping):
        [[13.55 -5.68 -5.68  0.    0.    0.  ]
         [-5.68 13.55 -5.68  0.    0.    0.  ]
         [-5.68 -5.68 13.55  0.    0.    0.  ]
         [ 0.    0.    0.   12.99  0.    0.  ]
         [ 0.    0.    0.    0.   12.99  0.  ]
         [ 0.    0.    0.    0.    0.   12.99]]
        ...
        >>> print(S * 1000) # S in /TPa
        Compliance tensor (in Voigt mapping):
        [[[ 5.36 -0.89 -0.89  0.    0.    0.  ]
          [-0.89  5.36 -0.89  0.    0.    0.  ]
          [-0.89 -0.89  5.36  0.    0.    0.  ]
          [ 0.    0.    0.   50.    0.    0.  ]
          [ 0.    0.    0.    0.   50.    0.  ]
          [ 0.    0.    0.    0.    0.   50.  ]]
        <BLANKLINE>
         [[ 4.73 -1.15 -1.15  0.    0.    0.  ]
          [-1.15  4.73 -1.15  0.    0.    0.  ]
          [-1.15 -1.15  4.73  0.    0.    0.  ]
          [ 0.    0.    0.   25.    0.    0.  ]
          [ 0.    0.    0.    0.   25.    0.  ]
          [ 0.    0.    0.    0.    0.   25.  ]]]
        """
    ...
    def Voigt_average(self, axis=None, orientations=None):
        ...
        Stiffness tensor (in Voigt mapping):
        [[186.   134.   134.    -0.     0.     0.  ]
         [134.   211.47 108.53   0.     0.     0.  ]
         [134.   108.53 211.47   0.     0.     0.  ]
         [  0.     0.     0.    51.53   0.     0.  ]
         [  0.     0.     0.     0.    77.    -0.  ]
         [  0.     0.     0.     0.     0.    77.  ]]
    ...
    def Reuss_average(self, axis=None, orientations=None):
        ...
        >>> C.Reuss_average()
        Stiffness tensor (in Voigt mapping):
        [[208.86 122.57 122.57   0.     0.     0.  ]
         [122.57 208.86 122.57   0.     0.     0.  ]
         [122.57 122.57 208.86   0.     0.     0.  ]
         [  0.     0.     0.    43.15   0.     0.  ]
         [  0.     0.     0.     0.    43.15   0.  ]
         [  0.     0.     0.     0.     0.    43.15]]
        ...
        Stiffness tensor (in Voigt mapping):
        [[186.   134.   134.    -0.     0.     0.  ]
         [134.   198.85 121.15  -0.     0.     0.  ]
         [134.   121.15 198.85  -0.     0.     0.  ]
         [ -0.     0.    -0.    38.89   0.     0.  ]
         [  0.     0.     0.     0.    77.    -0.  ]
         [  0.     0.     0.     0.     0.    77.  ]]
    ...
    def Hill_average(self, axis=None, orientations=None):
        ...
        >>> C.Hill_average()
        Stiffness tensor (in Voigt mapping):
        [[217.83 118.08 118.08   0.     0.     0.  ]
         [118.08 217.83 118.08   0.     0.     0.  ]
         [118.08 118.08 217.83   0.     0.     0.  ]
         [  0.     0.     0.    49.87   0.     0.  ]
         [  0.     0.     0.     0.    49.87   0.  ]
         [  0.     0.     0.     0.     0.    49.87]]
        ...
        Stiffness tensor (in Voigt mapping):
        [[186.   134.   134.    -0.     0.     0.  ]
         [134.   205.16 114.84  -0.     0.     0.  ]
         [134.   114.84 205.16  -0.     0.     0.  ]
         [ -0.     0.    -0.    45.21   0.     0.  ]
         [  0.     0.     0.     0.    77.    -0.  ]
         [  0.     0.     0.     0.     0.    77.  ]]
    ...
    def is_cubic(self, tol=0.01):
        ...
        >>> C_rotated
        Stiffness tensor (in Voigt mapping):
        [[237.71  96.41 119.87   8.19  -3.64 -20.34]
         [ 96.41 250.75 106.84   9.33  -6.53   1.  ]
         [119.87 106.84 227.29 -17.52  10.16  19.35]
         [  8.19   9.33 -17.52  49.84  19.35  -6.53]
         [ -3.64  -6.53  10.16  19.35  62.87   8.19]
         [-20.34   1.    19.35  -6.53   8.19  39.41]]
