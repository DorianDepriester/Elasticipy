...
class TestFourthOrderTensor(unittest.TestCase):
    ...
    def test_average(self):
        ...
        weights = (1,2,3,4)
        b_wgt = b.weighted_average(weights=weights)
        assert b_wgt.shape == ()
